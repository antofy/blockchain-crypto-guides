...
Some wallets out there including Metaegg DeFi recommend the optimal transaction fee amount for the moment taking into account the current state of activity on the network.
